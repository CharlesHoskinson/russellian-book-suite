# Capability: chapter-retrieval

The chapter-retrieval capability projects a deterministic, claim-first retrieval bundle per chapter for the book-compose writer. First defined by the `kg-chapter-retrieval-bundles` change (archived).
