...
def test_positive_triggers_referenced_in_description():
    ...
    keywords = ("draft", "chapter", "compile", "outline", "release bundle", "render", "publish", "compose")
    matched = 0
...
def test_negative_triggers_documented_in_description():
    description = _description().lower()
    refusal_terms = ["book-knowledge", "russellian-style", "source ingestion", "rewrites", "audited"]
