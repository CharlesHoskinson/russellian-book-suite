...
it recalls, reuses, and builds on chapters 1…N−1 — concept linkage, the N−1→N handoff seam,
and spiral coherence in the sense of Paul Halmos's *How to Write Mathematics* — and soft-gates
...
## Tests
`cd skills/halmos && .venv/Scripts/python.exe -m pytest tests/ -q`  (10 tests, stdlib only).
