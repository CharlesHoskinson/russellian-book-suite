...
def test_description_meets_anthropic_constraints():
    ...
    assert "use when" in desc.lower(), "description must include trigger phrasing"
    assert "do not" in desc.lower() or "do NOT" in desc, "description must include negative triggers"
