"""CLI entry point for the v0.3 Acquire sub-workflow.

The Acquire sub-workflow (expand_seeds, rank_candidates, triage, veto,
download_and_ingest, manifest) is scaffolded but inactive in v0.2.  It is
